      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
        {sortedFoods.map((food) => (
          <div key={food._id} className="relative bg-zinc-800 p-4 rounded-lg overflow-hidden">
            <div className='text-lg font-bold text-orange-400 absolute top-2 right-2'>{food.price} Tk</div>
            <img 
            ...
            <div className="mt-2">
              <button className="bg-orange-500 px-4 py-2 uppercase rounded-sm w-full">Order</button>
            </div>
          </div>
        ))}
      </div>
