...
const Sidebar = () => {
  return (
    <aside className="w-64 h-screen bg-gray-900 text-white p-5">
      ...
      <nav>
        <Link href="/dashboard" className=" py-2 hover:bg-gray-700 font-bold rounded flex item-center"><IoIosStats />Stats</Link>

        <Link href="/AdminRoutes/users" className="block py-2 hover:bg-gray-700 font-bold rounded"><UserSwitchOutlined/>Users</Link>

        <Link href="/AdminRoutes/add-food" className=" py-2 hover:bg-gray-700 font-bold rounded flex item-center"><IoIosAddCircle/>Add Food</Link>
