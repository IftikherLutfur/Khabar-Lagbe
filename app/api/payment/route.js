...
export const POST = async (req) => {
  try {
    ...
    const requestData = {
      ...
      success_url: `${process.env.NEXT_PUBLIC_DEPLOY_URL}/api/success?tran_id=${transactionId}`, // Success URL
      fail_url: `${process.env.NEXT_PUBLIC_DEPLOY_URL}/api/fail?tran_id=${transactionId}`, // Fail URL
      cancel_url: `${process.env.NEXT_PUBLIC_DEPLOY_URL}/api/cancel?tran_id=${transactionId}`, // Cancel URL
